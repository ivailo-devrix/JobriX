                        ...
                        <div class="primary-container">
                            ...
                            <div class="form-field-wrapper">
                                <input type="text" name="phone"
                                       placeholder="Phone Number" <?php if (!empty($_SESSION['input_phone'])) {
                        ...
                        <div class="secondary-container">
                            ...
                            <div class="form-field-wrapper">
                                <input type="text" name="company_name" placeholder="Company Name" <input
                                        type="text"
                                        name="phone"
                                        placeholder="Phone Number" <?php if (!empty($_SESSION['company_name'])) {
                            ...
                            <div class="form-field-wrapper">
                                <input type="text" name="company_site"
                                       placeholder="Company Site" <?php if (!empty($_SESSION['company_site'])) {
                            ...
                            <div class="form-field-wrapper">
                                    <textarea name="company_description"
                                              placeholder="Description" <?php if (!empty($_SESSION['company_description'])) {
